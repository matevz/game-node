...
const agent = new GameAgent(process.env.GAME_API_KEY ?? "", {
  ...
  goal: "find pool address '0x88e6a0c2ddd26feeb64f039a2c41296fcb3f5640' on network 'eth', include 'base_token,quote_token'.",
  description:
  ...
  workers: [
    coingeckoMAOPPlugin.getWorker({
      functions: [coingeckoMAOPPlugin.specificPoolData],
    }),
  ],
});
